...
(* OASIS_START *)
(* DO NOT EDIT (digest: 13cddb4feff9a17169ff5bc194e6465b) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "mqueue"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\206\022\1649\167j\241\029\178\214\198&s,\183\222";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

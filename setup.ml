...
(* OASIS_START *)
(* DO NOT EDIT (digest: 10a3f067f498e0bcb80d6692d4a952f5) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://mqueue.forge.ocamlcore.org/";
          synopsis = "POSIX message queues";
          description =
            Some
              [
                 OASISText.Para
                   "The mqueue library is a small OCaml library providing types and functions for using POSIX message queues. The types and functions try to stay close to the C API. This library has been tested on Linux, but QNX, Solaris etc. should work, too. Mac OS X on the other hand does NOT provide POSIX message queues (as of OS X 10.10)."
              ];
          categories = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_cclib = [(OASISExpr.EBool true, ["-lrt"])];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for POSIX message queues";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "posix-mqueue"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools = [InternalExecutable "mqtest"]
                   })
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\226\252\156\182\\K;\187U\142*\tB\198\240\012";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
